...
import DpoLgpd from './pages/Dpo.Lgpd'
...
const App = () => {
  return (
   <BrowserRouter>
   <CssBaseline />
   <Container maxWidth='lg' sx={{backgroundColor: '#f7f7f7', minHeight: '100vh', 
    padding: '16px', borderRadius: '8px '}}>
    <Box display='flex' alignItens='center' justifyContent='space-between' p={2} 
